...
$.get("/map", function(data) {
    ...
    AmCharts.ready(function() {
        ...
        for (var i = 0; i < mapData.length; i++) {
            ...
            if (dataItem.overall_category === "SCIENCE") {
                dataItem.color = "#4285F4";
            } else if (dataItem.overall_category === "CULTURE") {
                dataItem.color = "#EA4335";
            } else if (dataItem.overall_category === "ENGINEERING") {
                dataItem.color = "#FBBC05";
            } else if (dataItem.overall_category === "TECHNOLOGY") {
                dataItem.color = "#34A853";
            } else if (dataItem.overall_category === "MUSIC") {
