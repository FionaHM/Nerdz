...
("I like to read biographies.", "CULTURE", now(), now()),
("Enjoy going to fiction conventions.", "SCIENCE, ENGINEERING, TECHNOLOGY", now(), now()),
...
("I prefer spending time with machines more than with people.", "TECHNOLOGY, ENGINEERING", now(), now()),
